...
\proficient.skill {choose: {count:2, from: [athletics, intimidation, medicine, insight, religion, persuasion]}}

\page 84, "ЧАСТЬ 1 : КЛАССЫ"
### Снаряжение
Вы начинаете со следующим снаряжением в дополнение к снаряжению, полученному за вашу предысторию:
\equipment {a: [type.weaponMartial, armor.shield], b: [type.weaponMartial, quantity:2]}
\equipment {a: [{item: javelin, quantity:5}], b: [type.weaponSimpleMelee]}
\equipment {a: [packs.priest], b: [packs.explorer]}
\equipment {_: [armor.chain_mail, {item:holy_symbol]}
