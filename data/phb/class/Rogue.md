...
\proficient.weapon simple, hand_crossbow, longsword, rapier, shortsword
\proficient.saves dex, int
\proficient.tools thieves_tools
\proficient.skill {choose: {count:4, from: [acrobatics, athletics, perception, performance, intimidation, sleight_of_hand, deception, insight, stealth, persuation]}}

\page 96, "ЧАСТЬ 1 : КЛАССЫ"
#### Снаряжение
Вы начинаете со следующим снаряжением в дополнение к снаряжению, полученному за вашу предысторию:
\equipment {a: [{item: rapier}], b: [{item: shortsword}]}
\equipment {a: [{item: shortbow}, {item: arrow, quantity:20}], b: [{item: shortsword}]}
\equipment {a: [packs.birglar], b:[packs.dungeoneer], c:[packs:explorer]}
\equipment {_: [armor.leather, {item: dagger, quantity:2}, {item: tools.thieves}]}
...
\generic.feature.asi 4, 8, 10, 12, 16, 19
