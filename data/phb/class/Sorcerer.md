...
#### Владение
\proficient.armor
\proficient.weapon dagger, dart, sling, quarterstaff, light_crossbox
\proficient.saves con, cha
\proficient.skill {choose: {count:2, from: [intimidation, arcana, deception, insight, religion, persuasion]}}
...
\equipment {_: [{item: dagger, quantity:2}]}
...
\table.caption Создание ячеек заклинаний
