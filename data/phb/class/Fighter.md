...
### Владение
\proficient.armor light, medium, heavy, shields
\proficient.weapon simple, martial
\proficient.saves str, con
\proficient.skill {choose: {count:2, from: [acrobatics, athletics, perception, survival, intimidation, history, insight, animal_handling]}}

### Снаряжение
Вы начинаете со следующим снаряжением в дополнение к снаряжению, полученному за вашу предысторию:
\equipment {a: [armor.chain_mail], b: [armor.leather, {item:longbow}, {item:arrow, quantity:20}]}
\equipment {a: [type.weaponMartial, armor.shield], b: {item:type.weaponMartial, quantity:2}]}
\equipment {a: [{item:light_crossbow}, {item: crossbow_bolt, quantity:20}], b: [{item: handaxe, quantity:2}]}
...
\generic.feature.asi 4, 6, 8, 12, 14, 16, 19
